...
var metrics = [];
metrics['AVRG_KB'] = { retrieveMetric: 1, id: '1653:Average KB/transaction:4' };
metrics['TRAN_PS'] = { retrieveMetric: 1, id: '1654:Transactions/sec:4' };
metrics['IOMB_PS'] = { retrieveMetric: 1, id: '1655:IO MB/sec:4' };
...
function monitor()
{
    ...
    ls.on('exit', function (code) {
		if (code === 127)
	   		errorHandler(new UnableToGetMetricsError('Command \'iostat\' not found.'));
		else if (code !== 0)
